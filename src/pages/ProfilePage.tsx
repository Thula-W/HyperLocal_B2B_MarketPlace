...
const ProfilePage: React.FC = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      // Show profile completion modal for users without company info
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-gray-900">
                        {user?.companyDetails?.name || user?.company || (
                    ...
                    <div className="mt-3 p-3 bg-amber-50 border border-amber-200 rounded-md">
                      <div className="flex items-center">
                        ...
                        <p className="text-sm text-amber-700">
                          Complete your business information to access all
                          features and improve your visibility.
                        </p>
                      </div>
                    </div>
                  )}
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 mb-8">
            ...
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex space-x-3">
                  ...
                  <Link to="/make-listing" className="btn-primary">
                ...
                {listings.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500 mb-4">
                      Create your first listing to start connecting with other
                      businesses.
                    </p>
                    <Link to="/make-listing" className="btn-primary">
          ...
          {activeTab === "inquiries-received" && (
            <div className="p-6">
              ...
              <div className="space-y-4">
                {inquiries.received.length > 0 ? (
                  inquiries.received.map((inquiry) => (
                    <div
                      key={inquiry.id}
                      className="bg-white rounded-lg border border-gray-200 p-6"
                    >
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500">
                      When others inquire about your listings, they'll appear
                      here.
                    </p>
                  </div>
                )}
          ...
          {activeTab === "inquiries-made" && (
            <div className="p-6">
              ...
              <div className="space-y-4">
                {inquiries.sent.length > 0 ? (
                  inquiries.sent.map((inquiry) => (
                    <div
                      key={inquiry.id}
                      className="bg-white rounded-lg border border-gray-200 p-6"
                    >
                        ...
                        inquiry.purchaseAmount && (
                          <div className="bg-green-50 border border-green-200 rounded-md p-3 mb-4">
                            <p className="text-sm font-medium text-green-800">
                              ...
                              {inquiry.purchaseAmount.toFixed(2)}
                            </p>
                            {inquiry.purchaseDate && (
                              <p className="text-xs text-green-600 mt-1">
                                Purchased on{" "}
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500">
                      When you inquire about listings, they'll appear here.
                    </p>
                  </div>
                )}
              </div>
                      ...
                      {user.companyDetails.website && (
                        <div>
                          ...
                          <p className="text-gray-900 bg-white rounded-md px-3 py-2 border">
                            <a
                              href={
                                user.companyDetails.website.startsWith("http")
                                  ? user.companyDetails.website
                                  : `https://${user.companyDetails.website}`
                              }
                              target="_blank"
                ...
                {(!user?.companyDetails || stats.profileCompletion < 100) && (
                  <div className="bg-amber-50 border border-amber-200 rounded-lg p-6">
                    ...
                    <p className="text-amber-800 mb-4">
                      A complete profile helps you connect better with other
                      businesses and increases your visibility.
                    </p>
                    <ul className="text-sm text-amber-700 space-y-1 mb-4">
                      {!user?.name && <li>• Add your full name</li>}
                      {!user?.companyDetails && (
                        <li>• Add your complete business information</li>
                      )}
                      {user?.companyDetails &&
                        !user?.companyDetails.description && (
                          <li>• Add a business description</li>
                        )}
                      {user?.companyDetails &&
                        !user?.companyDetails.website && (
                          <li>• Add your company website</li>
                        )}
                      <li>
              ...
              {loading ? (
                      ...
                      <div className="mb-4">
                        ...
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-gray-500">
                            Starting:{" "}
                            {formatPrice(auction.startingPrice.toString())}
                          </span>
                          <span className="font-medium text-primary-600">
                            Current:{" "}
                            {formatPrice(auction.currentBid.toString())}
                          </span>
                        </div>
                      </div>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-6">
                    Create your first auction to sell surplus products through
                    competitive bidding.
                  </p>
              ...
              {loading ? (
                ...
                <div className="space-y-4">
                  {userBids.map((bidItem) => (
                    <div
                      key={`${bidItem.auction.id}-${bidItem.bid.timestamp}`}
                      className="card"
                    >
                      <div className="flex justify-between items-start mb-4">
                        <div className="flex-1">
                          <h4 className="font-semibold text-gray-900 mb-1">
                            {bidItem.auction.title}
                          </h4>
                          <p className="text-sm text-gray-600 line-clamp-1">
                            {bidItem.auction.description}
                          </p>
                        </div>
                        <div className="text-right">
                          <div className="text-lg font-bold text-primary-600">
                            {formatPrice(bidItem.bid.amount.toString())}
                          </div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                        <div>
                          ...
                          <div className="font-medium">
                            {formatPrice(bidItem.auction.currentBid.toString())}
                          </div>
                        </div>
                        <div>
                          <div className="text-sm text-gray-600">
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-6">
                    Browse auctions and place your first bid on items you're
                    interested in.
                  </p>
